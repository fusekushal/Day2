...
class University:
    def __init__(self, name, location):
        self.__name = name #double underscore means private members/attributes
...
dept1 = Department("Tribhuvan University", "Balkhu", "Computer Engineering", "Dr. Sashidhar")
dept1.add_course("Machine Learning and Computational Intelligence")
dept1.add_course("Data Structures and Algorithm")

dept2 = Department("Tribhuvan University", "Balkhu", "Electrical Engineering", "Dr. Dev")
dept2.add_course("Electrical Machines")
dept2.add_course("High Voltage Engineering")
